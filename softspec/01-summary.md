...
- Design คือการสร้างแนวคำตอบที่ตรงต่อ requirement บางครั้งการออกแบบจะละรายละเอียดระดับล่างๆ ออกไป และการออกแบบนี้สุดท้ายก็จะกลายเป็นงานที่นำไปใช้งานจริงได้ ซึ่งงานตัวนี้ (เช่น โค้ดโปรแกรม) นั้นเป็นไปตาม Design ที่สมบูรณ์ครบถ้วนแล้ว
...
- Object Oriented Design (OOD/OD) เน้นการกำหนดวัตถุในซอฟต์แวร์ และความสัมพันธ์ระหว่างวัตถุที่ตรงต่อ requirement เช่น เครื่องบินอาจจะมี attribute tailNumber และเมธอด getFlightHistory ซึ่งตรงนี้ก็จะกลายเป็นคลาส Plane ใน Java ตอนเขียนโค้ด
...
UP ค่อนข้างยืดหยุ่นได้ สามารถเอาวิธีทำงานจากกระบวนวิธีอื่นๆ มาใช้ได้ เช่น การทำ test-driven development (เรียนไปนิดหน่อยใน Indv. Process คือการเขียน test นำโค้ด) ซึ่งมาจาก Extreme Programming (XP)
...
การทำงานแบบ iteration ก็เป็นลักษณะงานที่ยังเน้นหลักไม่รีบโค้ด (don't rush to code) คือก่อนจะเริ่ม iteration ก็ต้องมีการวางแผนก่อนเริ่มงานนิดหน่อย
...
- ลดความซับซ้อนได้ จากเดิมที่ต้องเสียเวลาวิเคราะห์ระบบนานๆ ก็แตกเป็นระบบย่อยๆ
...
1. เริ่มแรกก็จัด requirement workshop อาจจะสักสองวัน (เป็นแบบ timeboxed ห้ามยืดเพิ่ม) โดยให้มีทั้งฝ่ายขายและโปรแกรมเมอร์
   ...
   2. ให้ฝ่ายขายเลือกจากข้อ 1 มาสัก 10% ที่มีลักษณะดังนี้
      - สำคัญต่อระบบ (จะสร้างได้ต้องสร้างแก่นของโปรแกรมขึ้นมาก่อน)
      - สำคัญต่อธุรกิจ (ฟีเจอร์ที่มันเอาไปโม้ให้ลูกค้าได้)
      - ความเสี่ยงสูง (เช่นบอกว่าต้องสามารถรองรับงานได้ 500 งานพร้อมๆ กัน)
   3. วิเคราะห์ความต้องการโดยละเอียดของสิ่งที่เลือกไว้ในข้อ 2
2. ก่อนเริ่ม iteration ให้แบ่งบางส่วนจากสิ่งที่เลือกไว้มาออกแบบและสร้างใน iteration ถัดไป (เพราะบางที requirement บางตัวอาจจะใหญ่เกินกว่าที่จะทำใน iteration เดียวได้) แล้วก็ทำ task breakdown แบ่งเป็นงานย่อยๆ
3. เริ่ม iteration อาจจะสัก 3-4 สัปดาห์
...
5. ทำ 2-4 ซ้ำหลายๆ ครั้ง
6. พอผ่าน workshop จนวิเคราะห์งานไปได้เกือบหมดแล้วจะเข้าสู่ช่วง elaboration ซึ่งจะมีการประมาณงานและเวลาที่จะใช้ในการสร้างชิ้นงานสุดท้ายขึ้นมา โดยอาศัยข้อมูลจากการปฏิบัติงานที่ผ่านมา
...
ตัวอย่างวิธ๊ agile เช่น Scrum, XP, UP

### 2.7 Agile modelling

- Agile ไม่ได้แปลว่าไม่ต้องออกแบบ
- การออกแบบทำเพื่อให้เข้าใจตรงกัน ไม่ใช่ใช้ทำเป็นเอกสารกำกับ
- วาด UML ทำให้เราสามารถหาวิธีออกแบบที่เหมาะสมได้ง่ายกว่าการไปนั่งโค้ด
- อย่านั่งวาด UML ทั้งหมด ตรงไหนที่ง่ายๆ ก็ข้ามไปงมในโค้ดเอาได้ แต่ตรงที่มันยากๆ ก็ต้องออกแบบเป็น UML มาก่อน
- ใช้เครื่องมือง่ายๆ ไม่ต้องเอาคอมมาวาด ใช้ไวท์บอร์ดดีกว่าเพราะมันสามารถวาดได้ไวกว่า และแก้ได้ง่ายกว่า แถมใหญ่กว่่าจอคอม
...
- ไม่ต้องเน้นว่าวาด UML เป๊ะ แค่เอาว่าวาดแล้วเข้าใจตรงกันเป็นพอ
- อย่าวาดให้คนอื่นโค้ด แบบนั้นเป็นวิธี waterfall
...
UP ไม่่เหมือน waterfall เช่น Inception ก็ไม่ใช่ขั้นตอนกำหนด requirement แค่เป็นช่วงที่คำนวณความเป็นไปได้ของงาน หรือ Elaboration ก็ไม่ใช่ช่วง design งานแต่เป็นช่วงที่พัฒนาระบบหลักๆ แบบ iterative
